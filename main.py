...
class todo:
    def __init__(self, root):
     ...
     self.main_text=Listbox(self.root,height=9,bd=5,width=25,font='ariel, 20 italic bold')
     ...
     self.button= Button(self.root, text="ADD", font='sarif, 20 bold italic',
               width=10,bd=15,bg='pink',fg='black',command=add)
     self.button.place(x=30,y=180)
    

     self.button2= Button(self.root, text="DELETE", font='sarif, 20 bold italic',
                width=10,bd=15,bg='blue',fg='black',command=delete)
